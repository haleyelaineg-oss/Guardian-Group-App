...
function IncomeTable({ data, navigate, onRecordPayment }) {
  ...
  return <div className="responses-table-wrap income-table-wrap"><table className="responses-table"><thead><tr><th>Item</th><th>Invoice Status</th><th>Invoice Number</th><th>Amount</th><th>Amount Due</th><th>Amount Paid</th><th>Due Date</th><th>Actions</th></tr></thead><tbody>{data.incomes.map((income) => {
